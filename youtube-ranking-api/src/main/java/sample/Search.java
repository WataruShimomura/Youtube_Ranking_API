...
public class Search {
    ...
    public static void main(String[] args) {
        ...
        try {
            /*
             * The YouTube object is used to make all API requests. The last argument is required,
             * but because we don't need anything initialized when the HttpRequest is initialized,
             * we override the interface and provide a no-op function.
             */
            youtube =
                    new YouTube.Builder(HTTP_TRANSPORT, JSON_FACTORY, new HttpRequestInitializer() {
            ...
            /*
             * We are only searching for videos (not playlists or channels). If we were searching
             * for more, we would add them as a string like this: "video,playlist,channel".
             */
